...
<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-lg-4 p-b-60">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Santo Domingo
						Sector rosales 4 etapa
						Avenida Rio Chila y Angelino Medro (esquina)
					</p>

					<div class="p-t-27">
						<a href="https://www.facebook.com/MairyClothes" class="fs-18 cl7 hov-cl1 trans-04 m-r-16" target="_blank">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					</script> Todo los derechos reservador | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> 
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
