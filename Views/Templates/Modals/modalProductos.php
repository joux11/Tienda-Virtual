<div class="modal fade" id="modalFormProductos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
                ...
                <form id="formProductos" name="formProductos" class="form-horizontal">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div id="containerImages">
                            <!--<div id="div24">
                             <div class="prevImage">
                                 <img src="<?= media(); ?>/images/uploads/img_9ae918fac56dab6a342cb2dc9f7174c1.jpg">
                             </div>
  ...
  <div class="modal-dialog modal-xl" >
    <div class="modal-content">
      <div class="modal-header headerView">
        <h5 class="modal-title color" id="titleModal">Datos del Producto</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
